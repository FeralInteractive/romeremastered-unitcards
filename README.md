...
|Unit Card|Unit Info|
|------|-----------|
|![Unit Card](/roman_archer_auxillia.png)|![Unit Card](/roman_archer_auxillia_info.png)  |

**NOTE: This is _not_ a tutorial, simply just instructions and tips to render out an image used for portraits.**

## Provided Files

You can find the blender project root folder [here](/TWRR_portrait_render_blender/):
 ...
 * Supporting files
   * icons
A directory containing the icons which are baked into selected portraits. These can be simply added on top of the portrait after the render. ![unit_icons](/unit_icons.png)

   * textures
     * polyhaven
       * Contains the grass texture used for the floor plane.  This is a free texture from [polyhaven](https://polyhaven.com/) and is set up as a preset example for modders. ![floor_textures](/floor_textures.png)

     * TTWR
       * Contains the TTWR supporting textures, this does not include unit clothing due to the number of textures. You can extract all of the variants from the game data if you are looking to modify a specific unit from the game. ![supporting_textures](/supporting_textures.png)
...
![open_blender_1](/open_blender_1.png)

![open_blender_2](/open_blender_2.png)
...
![link_pose_action1](/link_pose_action1.png)

![link_pose_action2](/link_pose_action2.png)
...
![pose_n_render1](/pose_n_render1.png)

![pose_n_render2](/pose_n_render2.png)
...
![pose_n_render3](/pose_n_render3.png)
...
![portrait_types](/portrait_types.png)
...
![portrait_types2](/portrait_types2.png)
...
##### World shader setup
 ...
 ![worldshadersetup](/worldshadersetup.png)
...
Simply a reminder of pose id groups.
 ...
 ![Pose_Reference_Text](/Pose_Reference_Text.png)

#### Proxy_Character

 ![Proxy_Character](/Proxy_Character.jpg)

#### Extra_Objects

 ![Extra_Objects](/Extra_Objects.jpg)
...
### Portrait_info
 ...
 ![portrait_info](/portrait_info.jpg)

### Pose_info

 ![pose_info](/pose_info.jpg)
